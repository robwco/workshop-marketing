...
<div class="flex max-w-lg mx-auto">
	<div class="w-full block text-center text-lg">
		<img src="/images/workshop-logo-new-shed.png" class="mt-1" style="width:100%; max-width:110px;">
		
		<h1 class="leading-tight text-grey-darkest">Workshop helps picky frontend design firms find clients looking to build an amazing UX.</h1>
	</div>
</div>
...
<div class="w-full max-w-lg mx-auto flex py-4">	
	...
	<div class="w-1/2 self-center -mt-6">
		<p class="leading-normal text-grey-darker text-xl leading-normal my-4 font-serif">Sign up and get: exclusive projects + forum membership free <em>when you refer a project.</em></p>
